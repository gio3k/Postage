...
public static class ProjectUtil
{
	...
	public static object LoadAdd( IEnumerable<string> binaries, string path,
		List<string> references = null )
	{
		var instance = Load( binaries, path, references );
		StaticData.Loaded.Add( instance );
		return instance;
	}

	public static object LoadAddGame( IEnumerable<string> binaries, string path,
		List<string> references = null )
	{
		var instance = Load( binaries, path, references );
		StaticData.Loaded.Add( instance );
